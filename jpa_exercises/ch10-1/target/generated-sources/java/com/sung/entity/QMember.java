...
public class QMember extends EntityPathBase<Member> {
    ...
    public final SetPath<FavoriteFood, QFavoriteFood> favoriteFoods = this.<FavoriteFood, QFavoriteFood>createSet("favoriteFoods", FavoriteFood.class, QFavoriteFood.class, PathInits.DIRECT2);
